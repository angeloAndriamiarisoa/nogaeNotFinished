        ...
        <div class="row">
            <div class="col-sm">
                ...
                <p v-for="user in users" :key="user.id">
                    {{user.name}}
                    <button class="btn btn-primary" @click="updateAssignment(user.id)">ENREGISTER</button>
                </p>
...
export default {
    ...
    setup(props) {
        ...
        const { assigntaskWtoUser, getUserAssignedTask, assignments, error} = useAsssignment();
        ...
        const updateAssignment = async (id_user) => {
    ...
    //     const { assigntaskWtoUser, GetListTaskAssignmentsInProjectInSociety, assignments, error} = useAsssignment();
